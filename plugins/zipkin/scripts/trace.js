...
module.exports = async (filePath, parser, opts = defaultOptions) => {
  ...
  // Remove the import & change to connect to zipkins trace_id
  ast.program.body.shift()
  ast.program.body[0].expression.right.body.body[0].expression.right =
    object.member('req', '_trace_id', 'traceId')
